...
namespace AgConn.CrossPlatform
{
    public partial class AgConnService 
    {
       ...
       // public float hdopData, altitude = 0.00f, headingTrue = 0.00f,
       //     headingTrueDual = 0.00f, speed = 0.00f, roll = 0.00f;
       // public float altitudeData, speedData, rollData, headingTrueData, headingTrueDualData, ageData;
     
        public float altitude = 0.00f;
        public float headingTrue = 0.00f;
         public float headingTrueDual = 0.00f;
         public float speed = 0.00f;
         public float roll = 0.00f;
       
        public double latitude  = 0;
        public double longitude = 0; // latitudeSend, longitudeSend;
        
        //public ushort satellitesData, satellitesTracked = ushort.MaxValue, hdopX100 = ushort.MaxValue,
         //   ageX100 = 0;
         public ushort satellitesTracked = 0;
         public ushort hdopX100 = 0;
         public ushort ageX100 = 0;

        //imu data
       //public ushort imuHeadingData, imuHeading = 0;
       // public short imuRollData, imuRoll = short.MaxValue, imuPitchData, imuPitch = short.MaxValue,
        //    imuYawRateData, imuYawRate = 0;

       public ushort imuHeading = 0;
        public short imuRoll = 0;
        public short imuPitch = 0;
         public short imuYawRate = 0;
        ...
        private void ParseKSXT()
        {
                ...
                && !string.IsNullOrEmpty(words[4]) && !string.IsNullOrEmpty(words[5]))
            {
               ...
               // float.TryParse(words[20], NumberStyles.Float, CultureInfo.InvariantCulture, out ageData);
                ...
                try
				{
					ageData = float.Parse(words[8], CultureInfo.InvariantCulture);
				}
				catch (FormatException e)
				{
				   Console.WriteLine(e); // Handle the exception
				}
				ageX100 = (ushort)(ageData * 100.0);
...
//float hdopData = 0.0f;
				try
				{
					hdopData = float.Parse(words[8], CultureInfo.InvariantCulture);
				}
				catch (FormatException e)
				{
				   Console.WriteLine(e); // Handle the exception
            ...
            */
                ...
                && !string.IsNullOrEmpty(words[4]) && !string.IsNullOrEmpty(words[5]))
            {
               ...
               // hdopX100 = (ushort)(hdopData * 100.0);
				...
				short hdopX100 = (short)(hdopData * 100.0);
