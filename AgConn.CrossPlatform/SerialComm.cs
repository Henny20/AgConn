    ...
    public partial class AgConnService
    {
        ...
        public async void OpenIMUPort()
        {
            ...
            if (spIMU.IsOpen)
            {
                ...
                //TODO  lblIMUComm.Text = portNameIMU;
            }
        }
        ...
        public async void OpenSteerModulePort()
        {
            ...
            if (spSteerModule.IsOpen)
            {
                ...
                //TODO  lblMod1Comm.Text = portNameSteerModule;
            }
        }
        ...
        public async void OpenMachineModulePort()
        {
            ...
            if (spMachineModule.IsOpen)
            {
                ...
                //  //TODO  lblMod2Comm.Text = portNameMachineModule; TODO
            }
        }
        ...
        public async void CloseMachineModulePort()
        {
            if (spMachineModule.IsOpen)
            {
                ...
                catch (Exception e)
                {
                    //WriteErrorLog("Closing Machine Serial Port" + e.ToString());
                    //MessageBox.Show(e.Message, "Connection already terminated??");
                    // var msbox = MessageBoxManager.GetMessageBoxStandard(e.Message, "Connection already terminated??");      await msbox.ShowWindowDialogAsync(this);  TODO
                }
        ...
        public void OpenGPSPort()
        {
            ...
            if (spGPS.IsOpen)
            {
                ...
                Properties.Settings.Default.Save();
                //TODO  lblGPS1Comm.Text = portNameGPS;
